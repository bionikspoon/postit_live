...
This will run all tests in the [`./postit_live/static/postit_live/__tests__`][test-dir] directory.
...
Open the lcov-report for an overview of your code coverage:
    ...
    $ open postit_live/static/postit_live/dist//reports/coverage/lcov-report/index.html
...
#### Source `./postit_live/static/postit_live/`
Main project source.

#### Actions `./postit_live/static/postit_live/actions/`
...
#### Components `./postit_live/static/postit_live/components/`
React components. Mostly __dumb__ components.

#### Constants `./postit_live/static/postit_live/constants/`
Stuff that doesn't change. Redux action types.

#### Containers `./postit_live/static/postit_live/containers/`
...
[test-dir]: /postit_live/static/postit_live/__tests__/
