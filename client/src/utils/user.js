...
//     .map(([attr, label], index) => {
//       debug('user.can[attr]', user.can[attr]);
//       debug('!!(user.can[attr].checked)', !!(user.can[attr].checked));
//       return ({ permission: !!user.can[attr].checked, label, index });
//     });
// }
//
